...
def initialize_database():
    with get_connection() as connection:
        ...
        """)
    seed_mock_sensor_readings()

def seed_mock_sensor_readings():
    mock_readings = [
        ("ESP32-01", "F001", "2026-09-15T08:00:00Z", 25.8, 61.2, 1009.1, 101200),
        ("ESP32-01", "F001", "2026-09-15T08:30:00Z", 26.1, 62.5, 1009.0, 100100),
        ("ESP32-01", "F001", "2026-09-15T09:00:00Z", 26.4, 63.7, 1008.8, 98400),
        ("ESP32-01", "F001", "2026-09-15T09:30:00Z", 26.8, 64.1, 1008.6, 97000),
        ("ESP32-01", "F001", "2026-09-15T10:00:00Z", 26.9, 64.9, 1008.4, 96100),
        ("ESP32-01", "F001", "2026-09-15T10:30:00Z", 27.1, 65.4, 1008.2, 95321),
        ("ESP32-01", "F001", "2026-09-15T11:00:00Z", 27.3, 65.8, 1008.0, 94750),
        ("ESP32-01", "F001", "2026-09-15T11:30:00Z", 27.6, 66.2, 1007.8, 93900),
        ("ESP32-01", "F001", "2026-09-15T12:00:00Z", 27.8, 66.7, 1007.6, 93100),
        ("ESP32-02", "F002", "2026-09-15T08:00:00Z", 24.9, 59.8, 1009.4, 112300),
        ("ESP32-02", "F002", "2026-09-15T08:30:00Z", 25.0, 60.1, 1009.3, 111700),
        ("ESP32-02", "F002", "2026-09-15T09:00:00Z", 25.2, 60.4, 1009.1, 110900),
        ("ESP32-02", "F002", "2026-09-15T09:30:00Z", 25.4, 60.7, 1009.0, 110100),
        ("ESP32-02", "F002", "2026-09-15T10:00:00Z", 25.6, 61.0, 1008.9, 109400),
        ("ESP32-02", "F002", "2026-09-15T10:30:00Z", 25.8, 61.3, 1008.7, 108700),
        ("ESP32-02", "F002", "2026-09-15T11:00:00Z", 25.9, 61.7, 1008.6, 108100),
        ("ESP32-02", "F002", "2026-09-15T11:30:00Z", 26.1, 61.9, 1008.5, 107400),
        ("ESP32-02", "F002", "2026-09-15T12:00:00Z", 26.2, 62.1, 1008.3, 106700),
    ]
    with get_connection() as connection:
        existing = connection.execute("SELECT COUNT(*) FROM sensor_readings").fetchone()[0]
        if existing <= 2:
